...
def fetch_words_data(url=data_url, words_data=data_dir):
    ...
    # Path to zip file
    zip_path = os.path.join(words_data, r"D:\aaSummer semester\aa python deeplearning course\icp\deep learning\deep3\DeepLearning_Lesson3\DeepLearning_Lesson3\Word2Vec.zip")
